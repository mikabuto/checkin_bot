...
def create_inkb_reg(user_id, event_id, addition=""):
	...
	if db.if_user_registered(user_id, event_id):
		inkb.add(InlineKeyboardButton(text='❌ Отменить регистрацию', callback_data=addition+'unregister_user_'+str(event_id)))
		...
		inkb.add(InlineKeyboardButton(text='✅ Зарегистрироваться', callback_data=addition+'register_user_'+str(event_id)))
